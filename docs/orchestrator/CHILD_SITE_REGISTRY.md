...
| ------------------ | --------------------------- | ------------------------ | --------------------------------------------------------------------------------------------- | -------------------------- | --------------------- | -------------------------------------------------------------------- | ------------------------------------------------------------------------------- | ------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Systems and Syntax | `richardjoo/richardjoo-com` | `https://richardjoo.com` | `emdash@0.33.0`, `@emdash-cms/cloudflare@0.33.0`, `astro@7.0.3`, `@astrojs/cloudflare@14.0.1` | Released npm packages only | none                  | Single-agent for CMS upgrades; two-agent allowed for site-local work | Standardized local handover package present; AGENTS/README/runbook also updated | 2026-08-14    | Single-brand reference site; package alignment to released `0.33.0` is installed, built, and typechecked locally. Cloudflare Email Sending remains configured and selected in production, and live test delivery succeeds when notifications target `richardjoo@gmail.com` while sender identity remains `aiopsforfounders@richardjoo.com`. |
