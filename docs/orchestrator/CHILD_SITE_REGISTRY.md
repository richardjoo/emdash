...
| ------------------ | --------------------------- | ------------------------ | --------------------------------------------------------------------------------------------- | -------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------- | ------------- | ------------------------------------------------------------------------------------------------------------------------ |
| Systems and Syntax | `richardjoo/richardjoo-com` | `https://richardjoo.com` | `emdash@0.28.1`, `@emdash-cms/cloudflare@0.28.1`, `astro@7.0.3`, `@astrojs/cloudflare@14.0.1` | Released npm packages only | none | Single-agent for CMS upgrades; two-agent allowed for site-local work | Partial standardization: `README.md`, `AGENTS.md`, and custom docs present; standard runbook/status files still to be aligned | 2026-07-10    | Single-brand reference site; upgraded to released packages after the seed-repair and Cloudflare OAuth env fixes landed upstream; local `pnpm typecheck` and `pnpm build` passed |
