...
EmDash runs on any Node.js 22.13.0+ hosting platform. This guide uses SQLite with local or S3-compatible storage; libSQL and PostgreSQL work the same way on Node.js — see [Database Options](/deployment/database/).

## Prerequisites

- Node.js v22.13.0 or higher (odd-numbered versions are not supported)
